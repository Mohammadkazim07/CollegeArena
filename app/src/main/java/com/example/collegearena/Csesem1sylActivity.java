...
public class Csesem1sylActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csesem1syl);
    ...
    private void initData() {
        ...
        creditsList.add(new Credits("CHEMISTRY", "L:3 T:1 P:3 CREDIT 5.5","", "MODULE 1: ATOMIC AND MOLECULAR STRUCTURE (10 LECTURES)" +
                ...
                "SCHORE, 5TH EDITION\n\n\n" ));
        creditsList.add(new Credits("MATHEMATICS -I (CALCULUS & LINEAR ALGEBRA)","L:3 T:1 P:0 CREDIT:4","","MODULE 1: CALCULUS (8 LECTURES).\n" +
